...
"""
function draw_points_with_GP_and_save(n_points::Int64; params_names::Array{Symbol,1}, xdata::Array{Float64,2}, mean_f::Float64, ydata::Vector{Float64}, ydata_err::Vector{Float64}, kernel::Function, hparams::Vector{Float64}, prior_bounds::Union{Array{Tuple{Float64,Float64},1}, Nothing}=nothing, max_mean::Float64=Inf, max_std::Float64=Inf, max_post::Float64=Inf, save_path::String="")
...
save_path = data_path #joinpath(data_path, "Transformed_rates")
